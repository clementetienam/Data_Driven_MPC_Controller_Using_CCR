function predicted_states=MPC_controller_states(oldfolder,ff,...
    loop_clement,ensemble,Result_folder,y_train,pred_ini)
%%
cd(oldfolder);
...
hold on
plot(Simmini,'k--','LineWidth',1)
hold on
plot(Simm_GA_unchanged,'b--','LineWidth',1)
hold off
...
legend('True room Temperature','Predicted temperature from LSTM','optimised temperature','location','northeast');
set(gca, 'FontName','Helvetica', 'Fontsize', 9)
set(gcf,'color','white')
cd(Result_folder)
saveas(gcf,'PredictionandoptimisedLBFGSclosed','fig')
cd(oldfolder)
...
methodInfo.maxOuterIter = 40; % maximum iteration number in the outer loop
methodInfo.maxInnerIter = 25; % maximum iteration number in the inner loop
...
hold on
plot(Simmini,'g--','LineWidth',1)

hold off
xlabel('Time','FontName','Helvetica', 'Fontsize', 13);
ylabel('Temperature','FontName','Helvetica', 'Fontsize', 13);
title('Temperature Trend','FontName','Helvetica', 'Fontsize', 13)
legend('True Temperature','I-ES','LSTM','location','northeast');
set(gca, 'FontName','Helvetica', 'Fontsize', 9)
set(gcf,'color','white')
cd(Result_folder)
saveas(gcf,'PredictionandoptimisedIESclosed','fig')
cd(oldfolder)
